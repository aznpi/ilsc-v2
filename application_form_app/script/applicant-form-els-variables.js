const schoolVal = 'ELS',
    ...
    releaseFormStatementHtml = "<div class='agreement-check'><input type='checkbox' id='release-check' name='release_checkbox' value='Yes, I agree to the release form statement' required><label for='release-check'>Yes, I read and agree to the above statement of release<sup>*</sup></label></div><div>By submitting this form by clicking the confirmation button below, you acknowledge that you have read and agreed to the <a href='https://www.els.edu/terms-of-use' target='_blank'>Terms of Use</a>, <a href='https://www.els.edu/privacy-policy' target='_blank'>Privacy Policy</a>, <a href='https://www.els.edu/how-to-apply/terms-conditions' target='_blank'>Cancellation & Refund Policy</a> and <a href='https://www.els.edu/admissions/tuition-fees' target='_blank'>Prices & Dates addendum</a>.</div>",
    ...
    pageUri = 'https://www.els.edu/online-application',
