...
const completeInfoArray = [
  ...
  },
  {
    ...
    objInputName:
      "student_declaration_and_acknowledgement_for_ilsc_language_schools_canada",
    inputType: "checkbox",
    required: true,
    category: "Application",
    value: "",
  ...
  },
  {
    ...
    objInputName:
      "student_declaration_and_acknowledgement_for_greystone_college_canada",
    inputType: "checkbox",
    required: true,
    category: "Application",
    value: "",
  ...
  },
  {
    ...
    objInputName:
      "agent_declaration_and_acknowledgement_for_ilsc_language_schools_canada",
    inputType: "checkbox",
    required: true,
    category: "Application",
    value: "",
  ...
  },
  {
    ...
    objInputName:
      "agent_declaration_and_acknowledgement_for_greystone_college_canada",
    inputType: "checkbox",
    required: true,
    category: "Application",
    value: "",
  ...
  },
  {
    ...
    objInputName:
      "student_declaration_and_acknowledgement_for_greystone_college_ilsc",
    inputType: "checkbox",
    required: true,
    category: "Application",
    value: "",
  ...
  },
  {
    ...
    objInputName:
      "agent_declaration_and_acknowledgement_for_greystone_college_ilsc",
    inputType: "checkbox",
    required: true,
    category: "Application",
    value: "",
  ...
  {
    inputLabel:
      "Yes, I read and agree to the above statement of FINANCIAL CERTIFICATION/PROOF OF FUNDS",
...
const juniorFamilyMembersInputArray = [
  ...
  },
  {
    ...
    category: "FamilyMember",
    value: "",
    obj: ["Brother", "Sister", "Mother", "Father"],
    displayShow: true,
  },
  {
    inputLabel: "Passport",
  ...
  },
  {
    ...
    category: "FamilyMember",
    value: "",
    obj: ["Small", "Medium", "Large", "X-Large"],
    displayShow: true,
  },
];
const dependentInputArray = [
  ...
  },
  {
    ...
    displayShow: true,
    helpText:
      "According to F-1 Visa regulations, only spouses and children are eligible for an F-2",
  },
];
const studentInfoArray = [
  ...
  {
    inputLabel:
      "First Name &nbsp;&nbsp;<span class='disclaimer'>(Fill in your first name as written in your passport)</span>",
  ...
  {
    inputLabel:
      "Given Name &nbsp;&nbsp;<span class='disclaimer'>(Fill in your given name as written in your passport)</span>",
    inputName: "student_first_name",
    objInputName: "firstname",
    inputType: "text",
    required: true,
  ...
  {
    inputLabel:
      "Middle Name &nbsp;&nbsp;<span class='disclaimer'>(Fill in your middle name as written in your passport)</span>",
  ...
  {
    inputLabel:
      "Last Name &nbsp;&nbsp;<span class='disclaimer'>(Fill in your last name as written in your passport)</span>",
  ...
  {
    inputLabel:
      "Surname &nbsp;&nbsp;<span class='disclaimer'>(Fill in your surname as written in your passport)</span>",
    inputName: "student_last_name",
    objInputName: "lastname",
    inputType: "text",
    required: true,
...
const programInfoArray = [
  ...
  {
    inputLabel: "Are you also applying for Online programs?",
    inputName: "is_online_apply",
    objInputName: "apply_for_additional_online_programs",
    inputAssign: "primary",
    schoolDependence: "Language Schools,Greystone College",
    category: "Program",
    displayShow: true,
  },
  {
  ...
  {
    inputLabel:
      "Have you or your student taken the Pre-Arrival Language Placement test?",
  ...
  {
    inputLabel:
      "Upload all the visa copies you have previously since arriving in Australia",
  ...
  {
    inputLabel:
      "Are you in possession of a valid US student visa and would like to transfer from another institution?",
  ...
  },
  {
    ...
    inputName: "government_sponsored_student",
  ...
  },
  {
    ...
    inputName: "approximate_english_level",
  ...
  {
    inputLabel:
      "Flight details that shows your arrival date in Canada (jpeg,png,pdf; max. size: 1mb)",
  ...
  {
    inputLabel:
      "Study Permit or your Canadian visa (TRV or eTA) (jpeg,png,pdf; max. size: 1mb)",
...
const accommodationInfoArray = [
  ...
  },
  {
    ...
    category: "Accommodation",
    countryDependence: "Canada,Australia,India,Ireland",
  },
  {
  ...
  {
    inputLabel:
      "Will you be booking unaccompanied minor service through your airline?",
  ...
  },
  {
    ...
    obj: [
      ...
      },
      {
        ...
        optionMultiObj: [
          {
            ...
            inputName:
              "accommodation_homestay_add_comfortable_children_specified",
            objectName:
              "accommodation_homestay_add_comfortable_children_specified",
            inputType: "radio-option",
            required: false,
        ...
        dependentClass:
          "accommodation_homestay_add_comfortable_children_option",
      },
    ],
    displayShow: true,
  },
    ...
    obj: [
      {
        ...
        optionType: "option-other",
        optionName:
          "accommodation_homestay_add_comfortable_other_students_specified",
        dependentClass:
          "accommodation_homestay_add_comfortable_other_students_option",
        placeholder: "Specify",
      },
      {
        optionLabel: "Yes",
...
const fileUploadArray = [
  ...
  {
    inputLabel:
      "Passport Photo Page (for you and dependents) (jpeg,png,pdf; max. size: 1mb)",
    inputName: "additional_passport_file",
    objInputName: "passport_copy",
    inputType: "file",
    category: "Additional",
  ...
  {
    inputLabel:
      "Visa Copy (or the certificate of residencey, residence status, etc.) (jpeg,png,pdf; max. size: 1mb)",
  ...
  {
    inputLabel:
      "Genuine Temporary Entrant - Statement of Purpose Copy (jpeg,png,pdf; max. size: 1mb) (<a href='https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/student-500/genuine-temporary-entrant#:~:text=%E2%80%8B%E2%80%8B%E2%80%8B%E2%80%8BAll,to%20apply%20for%20permanent%20residence' target='_blank'>More Info</a>)",
    helperHtml:
      "<p>Further documents might be required throughout the application process.</p>",
  ...
  {
    inputLabel:
      "Affidavit Support (See Section B above) (jpeg,png,pdf; max. size: 1mb) (<a href='https://assets.contentstack.io/v3/assets/blte6ca0397941e65d8/bltb8a1447c0841a194/6298de5961670f0fb5dd0866/ELS_Affidavit_of_Support.pdf' target='_blank' download>download form</a>)",
...
const additionalInfoArray = [
  {
    inputLabel:
      "Yes, for good and valuable consideration, the receipt and sufficiency of which is acknowledged, I, the parent or legal guardian, of the child (or legal guardian if the student is unable to enter into binding agreements in the jurisdiction in which the School operates) hereby agrees as above.",
  ...
  {
    inputLabel:
      "Yes, I confirm that I have read, understood and agree to the above rules and consequences.",
  ...
  {
    inputLabel:
      "Should my child require medical attention during the course, I consent to this and authorize an ILSC Team member to bring them to the doctor, clinic and/or hospital.",
  ...
  {
    inputLabel:
      "Do you need ILSC/Greystone College/ELS to organize your Overseas Student Health Coverage (medical insurance)?",
  ...
  {
    inputLabel:
      "Do you have any health conditions we should be aware of before you enroll in studies with us?",
    inputName: "additional_health_condition_option",
    objInputName: "do_you_have_any_physical_or_mental_medical_conditions_",
    inputType: "radio-option",
    required: true,
  ...
  },
  {
    ...
    obj: [
      ...
      {
        optionLabel: "Yes, both ways",
        optionValue: "Yes, both ways",
        optionType: "strict",
      },
      {
        optionLabel: "Yes, arrival only",
        optionValue: "Yes, arrival only",
        optionType: "strict",
      },
      {
        optionLabel: "Yes, departure only",
        optionValue: "Yes, departure only",
        optionType: "strict",
      },
    ],
    displayShow: true,
  },
  {
    ...
    obj: [
      ...
      },
      {
        ...
        placeholder:
          "Please let us know the Full Name and Relationship of whom you will be travelling with.",
      },
    ],
    displayShow: true,
  },
...
const jrWaiverCAArray = [
  ...
  {
    textVal:
      "For students attending our Canadian programs, the laws applicable in the province of: British Columbia shall govern this <b>Waiver</b> if attending Junior Camp programs offered by ILSC-Vancouver; Ontario shall govern this <b>Waiver</b> if attending Junior Camp programs offered by ILSC-Toronto; Quebec shall govern this Waiver if attending Junior Camp programs offered by ILSC-Montreal LLC. I accept the courts of the province/state in which I am attending School. If a portion of this <b>Waiver</b> shall be found to be wholly or partially invalid, this Waiver will be interpreted as if the invalid portion had not been a part of this <b>Waiver</b>.",
  },
  {
    textVal:
      "This <b>Waiver</b> shall be effective and binding upon my heirs, next of kin, executors, administrators, families or representatives.",
  },
  {
    textVal:
  ...
  {
    textVal:
      "I agree and acknowledge that should my child be refused entry at any border crossing, or should a school activity itinerary be necessarily altered or otherwise interrupted due to acts of a political or social nature, or due to a natural “Act of God”, neither the school nor its employees, homestay families, third-party service providers, nor representatives shall be held responsible for any additional costs or expenses which my child or I, may incur as a result of such occurrence.",
  },
  {
    textVal:
      "In signing this <b>Waiver</b>, I am not relying upon any oral or written statements made by the School or its employees, homestay families, Uniglobe Specialty Travel Ltd. DBA West Trek Tours., or other third-party service providers or representatives other than as written in this <b>Waiver</b>.",
  },
  {
    textVal:
      "I have read and fully understand the contents of this <b>Waiver</b> and I am aware that by signing this Waiver, I am waiving certain legal rights which I or my family, next of kin, executors, administrators, and assigns may have against the School or its employees, homestay families, Uniglobe Specialty Travel Ltd. DBA West Trek Tours., The Bubble (Toronto), Rock Oasis (Toronto), The Hive (Vancouver) or other third-party service providers, or representatives.",
  },
];
...
const insideCountryHtml =
  ...
  usiHtml =
    '<div class="form-group"><label for="inputUsiNumber">USI Number</label><input type="text" name="additional_usi_number" id="inputUsiNumber"><div class="valid-feedback"></div></div>',
  visaRadioHtml =
  ...
  collegeInstituteAccordion =
    '<div class="form-group accordion study-hide" id="accordionInstitute"></div><div class="college-input study-hide"><label for="college-input">Please write the name of the US institution you will attend if not listed above.</label><input type="text" name="additional_college_name_input" id="additional_college_name_input" disabled><div class="valid-feedback"></div></div>',
  collegeInputUsHtml =
    '<div class="form-group college-input-hidden study-hide"><label for="college-input">Please enter the name of the US institution below if it is not listed above</label><input type="hidden" name="additional_college_name" id="additional_college_name" disabled><div class="valid-feedback"></div></div>',
  govSponsoredHtml =
    '<div class="form-group gov-sponsored"><label for="gov-sponsored-select">Are you a Government Sponsored Student?<sup>*</sup></label><div class="form-check"><select name="government_sponsored_student" id="gov-sponsored-select" required><option disabled value="" selected>Select</option><option value="Yes">Yes</option><option value="No">No</option></select></div></div>',
  englishLevelHtml =
    '<div class="form-group english-level"><label for="english-level-select">Please select your approximate level of English:<sup>*</sup></label><div class="form-check"><select name="approximate_english_level" id="english-level-select" required><option disabled value="" selected>Select</option><option value="Beginner">Beginner</option><option value="Elementary">Elementary</option><option value="Pre-Intermediate">Pre-Intermediate</option><option value="Intermediate">Intermediate</option><option value="Upper-Intermediate">Upper-Intermediate</option><option value="Advanced">Advanced</option></select></div></div>',
  additionalNotesHtml =
    '<div class="form-group college-input study-show"><label for="additional-notes-input">Enter any additional notes regarding your program of study</label><textarea name="study_additional_information_and_notes" id="additional-notes-input" cols="50" rows="10"></textarea><div class="valid-feedback"></div></div>',
  additionalOnlineNotesHtml =
    '<div class="form-group college-input study-show"><label for="additional-notes-input">Enter any additional notes regarding your program study</label><textarea name="study_additional_online_information_and_notes" id="additional-notes-input" cols="50" rows="10"></textarea><div class="valid-feedback"></div></div>',
    ...
    for (let i = 0; i < dataForm.length; i++) {
      $("form#" + dataForm[i]).validate({
        ...
        messages: {
          "program_startdate_primary-input": {
            required:
              "Please select a program start date. If none available, you may not be qualified for any programs due to your age. Please contact our representatives to inquire.",
          },
          student_email: {
...
const actionFormSubmitSuccess = function (formName, dataStep, success) {
  if (success) {
    $("form#" + formName).attr("data-submit", true);
    $(".fixed-side-menu ." + dataStep).addClass("complete");
...
const createAdvisorInfo = function () {
  ...
  api_url = api_url =
    apiUrl + enrolmentAdvisorTable + "/rows?portalId=" + portalId + queryParam;
...
const hideShowEnrolmentAdvisorForm = function (enable) {
  ...
  if (enable !== null) {
    ...
    if (enable != "") {
      $("select#enrolmentAdvisor option[data-id=" + enable + "]").prop(
        "selected",
        true
      );
    }
...
const getExchangeRate = function () {
  ...
  if (fromCurrency != toCurrency) {
    let fetchedData = fetch(
      "https://" + exHost + "/latest?from=" + fromCurrency + "&to=" + toCurrency
    )
      .then((resp) => resp.json())
      .then((data) => {
...
const printDropSelect = function (className) {
  $(className + " li.dropdown-item").on("click", function () {
    ...
    $(this)
      .parent()
      .siblings("button.dropdown-select")
      .attr("data-selected", getValue);
    $(this)
      .parent()
      .siblings("button.dropdown-select")
...
$(".section-application-form .step-container .btn-container .btn.prev").on(
  "click",
  function () {
...
$(document).on("click", "input.other-input", function () {
  if (!$(this).parent().hasClass("multi-target")) {
    $(this)
      .parent()
      .siblings(".dependent-target:lt(4)")
      .removeClass("study-hide")
      .addClass("study-show")
      .attr("disabled", false)
      .children("input")
...
$(document).on("click", "input.independent-input", function () {
  if ($(this).parent().hasClass("multi-target")) {
    $(this)
      .parent()
      .siblings("input.dependent-target")
      .not("other-input")
...
const returnComboVal = function (inputName) {
  let valueCombo =
    inputName.indexOf("combo") != -1
      ? inputName.substr(inputName.indexOf("_combo-") + 7, 99)
      : "1";
  return valueCombo;
};
...
const returnComboName = function (inputName) {
  let nameCombo =
    inputName.indexOf("combo") != -1
      ? inputName.substr(inputName.indexOf("_combo"), 99)
      : "";
  return nameCombo;
};
...
$(document).ready(function () {
  ...
  $(".application-step-form-slide").on(
    "afterChange",
...
$(document).on("click", ".fixed-side-menu ul li.complete a", function () {
  let step = $(this).parent().attr("data-step"),
    ...
    dataInit =
      $(".slick-current .step-container").attr("data-init") == "false"
        ? false
        : true;
  ...
  if ($(".slick-current").attr("data-slick-index") != 5) {
    if (dataInit) {
      submitVar =
        validateForm(step, dataForm, validCheck) == true ? true : false;
    } else {
      submitVar = true;
    }
  } else {
...
$(document).on("change", "form[data-submit=true]", function () {
  dataStep = $(this)
    ...
    .find("button.next")
    .attr("data-step");
  $(".fixed-side-menu ul li." + dataStep)
...
$(document).on(
  "change",
  "select[name=study_additional_preferred_currency_payment]",
  function () {
    let selectedCurrency = $(this).find(":selected").val(),
      selectedSchool = $("input[name=program_school]:checked").attr("id"),
      queryParam =
        "&currency__in=" + selectedCurrency + "&schools__in=" + selectedSchool;
...
$(window).scroll(function () {
  ...
  else $("nav.fixed-side-menu").removeClass("fixed");
  var check =
    $(".section-application-form").height() -
    $("nav.fixed-side-menu").height() -
    21;
  if ($(window).scrollTop() >= check)
    $("nav.fixed-side-menu").addClass("bottom");
  else $("nav.fixed-side-menu").removeClass("bottom");
});
  ...
  if (files.length < 6) {
    if (fileSizeInKB < fileLimit) {
      ...
      messageHtml =
        ...
        id +
        '">File is too large. Max file size accepted: ' +
        showLimit +
        "mb</label>";
    ...
    messageHtml =
      ...
      '-error" class="error" for="' +
      id +
      '">Exceeded max. number of files: 5 files max.</label>';
    inputElement.after(messageHtml);
    inputElement.val(""); // input form set to be empty
  }
};
$(document).on(
  "keyup",
  ".student-information-form input[name*=name]",
  function () {
