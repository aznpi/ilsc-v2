...
const fileUploadArray = [
    ...
    {
        inputLabel: "Please upload a proficiency test result (other than Prola) - ex: IELTS, TOEFL, Duolingo, etc. (jpeg,png,pdf; max. size: 1mb)",
...
const insideCountryHtml = '<label for="inside-question-yes">Are you currently inside Canada?<sup>*</sup><span class="footnote">If yes, please submit your Study Permit or your Canadian visa (TRV or eTA) with your flight details that shows your arrival date in Canada. This information it&apos;s required to process your registration.</span></label><div class="form-check"><input class="form-check-input" value="No" type="radio" name="additional_inside_canada" id="inside-question-no" checked required><label class="form-check-label" for="inside-question-no">No</label></div><div class="form-check"><input class="form-check-input" value="Yes" type="radio" name="additional_inside_canada" id="inside-question-yes" required><label class="form-check-label" for="inside-question-yes">Yes</label></div>',
    ...
    collegeInputUsHtml = '<div class="form-group college-input-hidden study-hide"><label for="college-input">Please enter the name of the US institution below if it is not listed above</label><input type="hidden" name="additional_college_name" id="additional_college_name" disabled><div class="valid-feedback"></div></div>',
    govSponsoredHtml = '<div class="form-group gov-sponsored"><label for="gov-sponsored-select">Are you a Government Sponsored Student?<sup>*</sup></label><div class="form-check"><select name="government_sponsored_student" id="gov-sponsored-select" required><option disabled value="" selected>Select</option><option value="Yes">Yes</option><option value="No">No</option></select></div></div>',
