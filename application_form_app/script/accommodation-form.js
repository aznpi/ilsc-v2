...
const showAccommodationDetailsOption = function(accommType){
    let countrySelected = $('input[name=program_country]').val(),
        accommTypeVal = countrySelected == 'USA' || countrySelected == 'Ireland' ? 'Residence-No-Code' : accommType,
